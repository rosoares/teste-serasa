...
import com.example.serasa.filter.TokenAuthenticationFilter;
import com.example.serasa.repository.UserRepository;
import com.example.serasa.service.impl.AuthenticationService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/docs.html").permitAll()
